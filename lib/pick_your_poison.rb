        ...
        CHICAGO_TZ = TZInfo::Timezone.get("America/Chicago")
            ...
            post '/submit' do
                ...
                if @errors.length == 0
                    ...
                    parsed_time_in_chicago_tz = Time.strptime(params[:problem_date], '%m/%d/%Y')
                    parsed_time_in_utc = CHICAGO_TZ.local_to_utc(parsed_time_in_chicago_tz)
                    params[:problem_date] = parsed_time_in_utc.iso8601
                    ...
                    response = HTTParty.post('http://test311api.cityofchicago.org/open311/v2/requests.json', :body => { 
                            ...
                            :attribute => {
                                :PLEASESE => 'FOODPOIS',
                                :WHATISTH => params[:restaurant_name],
                                :ONWHATDA => params[:problem_date]
                            },
